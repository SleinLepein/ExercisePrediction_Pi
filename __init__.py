...
try:
    ...
    #msg.set(f"Error while reading the blob: ({ex})")
else:
    ...
    if df.shape[0] >= MIN_ROWS:
        ...
        try:
            ...
            # get exercise, probability, repetitions and bool if data should be deleted afterwards
            exercise, probability, repetitions, delete_blob = predict_set(list_of_predicted_batches, df)
